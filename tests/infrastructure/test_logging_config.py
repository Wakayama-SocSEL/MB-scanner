...
from mb_scanner.infrastructure.logging_config import get_logger, setup_logging
...
def test_setup_logging_default(tmp_path: Path):
    ...
    # Act
    with patch("mb_scanner.infrastructure.logging_config.settings") as mock_settings:
