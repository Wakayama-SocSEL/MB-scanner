"""SqlAlchemyProjectRepository のテスト

このモジュールでは、SqlAlchemyProjectRepository の全機能をテストします。
...
def test_save_project_new(project_service: SqlAlchemyProjectRepository) -> None:
    """新規プロジェクト保存のテスト
...
def test_save_project_duplicate_skip(project_service: SqlAlchemyProjectRepository) -> None:
    """重複プロジェクトのスキップテスト
...
def test_save_project_update_if_exists(project_service: SqlAlchemyProjectRepository) -> None:
...
def test_save_project_with_topics(project_service: SqlAlchemyProjectRepository) -> None:
...
def test_save_project_without_topics(project_service: SqlAlchemyProjectRepository) -> None:
...
def test_save_project_update_topics(project_service: SqlAlchemyProjectRepository) -> None:
    """topics更新のテスト
...
def test_get_project_by_full_name_exists(project_service: SqlAlchemyProjectRepository) -> None:
...
def test_get_project_by_full_name_not_exists(project_service: SqlAlchemyProjectRepository) -> None:
...
def test_get_all_projects(project_service: SqlAlchemyProjectRepository) -> None:
    """全件取得のテスト
...
def test_get_all_projects_empty(project_service: SqlAlchemyProjectRepository) -> None:
    """全件取得（空）のテスト
...
def test_count_projects(project_service: SqlAlchemyProjectRepository) -> None:
    """件数カウントのテスト
...
def test_count_projects_empty(project_service: SqlAlchemyProjectRepository) -> None:
    """件数カウント（空）のテスト
...
def test_update_js_lines_count_success(project_service: SqlAlchemyProjectRepository) -> None:
    """JS行数の更新（正常系）のテスト
...
def test_update_js_lines_count_zero(project_service: SqlAlchemyProjectRepository) -> None:
    """JS行数の更新（0行）のテスト
...
def test_update_js_lines_count_nonexistent_project(
    project_service: SqlAlchemyProjectRepository,
) -> None:
...
def test_update_js_lines_count_negative_value(project_service: SqlAlchemyProjectRepository) -> None:
    """JS行数の更新（負の値）のテスト
