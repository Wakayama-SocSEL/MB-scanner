...
from mb_scanner.adapters.gateways.github import search as search_module
from mb_scanner.adapters.gateways.github.search import SearchCriteria, build_default_search_criteria
