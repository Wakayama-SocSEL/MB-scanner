...
from mb_scanner.services.benchmark_runner import (
...
class TestRunBatchEquivalenceCheck:
    ...
    def test_batch_basic(self, benchmark_dir: Path) -> None:
        ...
        summary = run_batch_equivalence_check(benchmark_dir)
    ...
    def test_batch_with_id_filter(self, benchmark_dir: Path) -> None:
        ...
        summary = run_batch_equivalence_check(benchmark_dir, target_ids={0, 2})
    ...
    def test_batch_with_count(self, benchmark_dir: Path) -> None:
        ...
        summary = run_batch_equivalence_check(benchmark_dir, count=2)
    ...
    def test_batch_with_offset(self, benchmark_dir: Path) -> None:
        ...
        summary = run_batch_equivalence_check(benchmark_dir, offset=1)
    ...
    def test_batch_parallel_execution(self, benchmark_dir: Path) -> None:
        ...
        summary = run_batch_equivalence_check(benchmark_dir, workers=4)
